_G.Settings = {
	UI = {
		Color = Color3.fromRGB(255, 0, 255), -- สีคอบเส้นGUI
		Logo = "  12359589383",
	},
}
...
local LogoUI = _G.Settings.Logo or "   12359589383" -- โลโก้ กับไอคอน ซ่อนGUI
...
function library:Window(options)
  ...
  mainDiscord.Name = "mainDiscord"
    ...
    mainDiscord.MouseButton1Click:Connect(function()
        setclipboard("https://discord.gg/SycjyP6g")
        wait(.1)
...
local postog12 = Instance.new("UIStroke")
 ...
 ImageLabel.Image = "rbxassetid://   12359589383"
...
spawn(function()
  ...
  pcall(function()
    ...
    Beli.Text = "Beli : "..game:GetService("Players").LocalPlayer.ServerPlayerData.CoinNum.Value
    Fragment.Text = "Fragment : "..game:GetService("Players").LocalPlayer.ServerPlayerData.GemNum.Value
