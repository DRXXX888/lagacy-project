...
ImageButton.Image = "rbxassetid://12862171447"
...
function Update:Window(text,logo,keybind)
	...
	Name.Text = "NaJa Hub | Map Blox Fruits - Free Script Version 0.1.15.1" --text
...
local win = Update:Window("   Kurumi X",[[     Hub]],[[BF]],"6022668898",Enum.KeyCode.RightControl)
local MainTab = win:Tab("Farm",[[7040391851]])
-------------->> // TAP \\ <<-------------
MainTab:Toggle("WhiteScreen",false,function(Value)
print(Value)
end)
...
MainTab:Dropdown("Dropdown",{"Normal","Hee","Kuy"},{""},function(Value)
	print(value)
end)
